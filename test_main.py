...
class Test(TestCase):
    ...
    def test_validate_json(self):
        ...
        invalid = [{"student1": ["view_grades", "view_classes"]},
                   {"student2": ["view_grades", "view_classes"]},
                   {"teacher": ["view_grades", "change_grades", "add_grades", "delete_grades", "view_classes"]}]
        self.assertTrue(validate_json(valid))
        self.assertFalse(validate_json(invalid))

    def test_parse_json(self):
        result_one = parse_json(self._json_files[0])
        result_two = parse_json(self._json_files[1])
    ...
    def test_update_lists_to_sets(self):
        ...
        result = next(update_lists_to_sets(records))
    ...
    def test_create_csv(self):
        try:
            headers = ['a', 'b', 'c']
            result = create_csv(self._csv_file, headers)
    ...
    def test_write_to_csv(self):
        try:
            ...
            records = {"student1": ["view_grades", "view_classes"],
                       "student2": ["view_grades", "view_classes"],
                       "teacher": ["view_grades", "change_grades", "add_grades", "delete_grades", "view_classes"]}
            result = write_to_csv(self._csv_file, headers, records)
            self.assertTrue(result)
            with open(self._csv_file, 'r') as fp:
    ...
    def test_main(self):
        try:
            self.assertEqual(1, main(["main.py"]))
            self.assertEqual(1, main(["main.py", self._json_files[0]]))
            self.assertEqual(0, main(["main.py", self._json_files[0], self._csv_file]))
            with open(self._csv_file, 'r') as fp:
                self.assertEqual("person,view_grades,change_grades,add_grades,"
                                 "delete_grades,view_classes,change_classes,add_classes,"
                                 "delete_classes\nstudent1,0,1,0,0,0,1,0,0,0\n"
